...
-- Diagnostic keymaps
vim.keymap.set('n', '<leader><f2>', vim.diagnostic.setloclist, { desc = 'Open diagnostic Quickfix list' })
...
require('lazy').setup({
  ...
  -- require 'kickstart.plugins.neo-tree', -- copied and modified in custom.plugins.filetree.lua
